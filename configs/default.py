...
_C.VOICE2POSE.GENERATOR.CHANGEWEIGHT = None
...
_C.VOICE2POSE.GENERATOR.DEEPSPEECH_FEATURE = False
_C.VOICE2POSE.GENERATOR.DEEPSPEECH_FEATURE_SIZE = 256
_C.VOICE2POSE.GENERATOR.SEED_POSE = False
...
_C.VOICE2POSE.POSE_DISCRIMINATOR.WARM_UP = 0
...
_C.DATASET.NUM_FACE_LANDMARKS = 70
_C.DATASET.NUM_BODY_LANDMARKS = 51
_C.DATASET.NUM_TORSO_LANDMARKS = 9
_C.DATASET.NUM_HAND_LANDMARKS = 42
_C.DATASET.NUM_LIP_KPS = 20
_C.DATASET.HIERARCHICAL_POSE = False
...
_C.DEEPSPEECH = CN()
_C.DEEPSPEECH.CKPT_PATH = '/home/wanghexiang/research/Speech2Gesture/deepspeech.pytorch/ckpt/ted_pretrained_v3.ckpt'
